...
if(isset($_POST['submit'])){
	...
	$recepient=Staff::find_staff_in_my_dept($session->user_id);
...
<nav class="art-nav">
    <ul class="art-hmenu"><li><a href="home.php" class="">Home</a></li><li><a href="applications.php" class="">Applications</a></li><li><a href="mails.php" class="active">Mails</a></li><li><a href="reports.php">Reports</a></li></ul> 
...
<ul class="art-vmenu"><li><a href="home.php" class="">Home</a></li><li><a href="applications.php" class="">Applications</a></li><li><a href="mails.php" class="active">Mails</a></li><li><a href="reports.php">Reports</a></li></ul>
...
<div class="messagebox">
    ...
    <form action="#" method="post" id="commentform">
		...
		<label for="author"><b>Select Recepient</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<?php  foreach($recepient as $recepient):   if($recepient->staff_id==$session->user_id){
			} else { ?>
