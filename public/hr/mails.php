...
if(isset($_POST['submit'])){
	...
	$recepient=Staff::find_all_except_hr($session->user_id);
...
<nav class="art-nav">
    <ul class="art-hmenu"><li><a href="home.php" class="">Home</a></li><li><a href="departments.php" class="">Departments</a></li><li><a href="staff.php" class="">Staff</a></li><li><a href="managers.php" class="">Managers</a></li><li><a href="leaves.php" class="">Leaves</a></li><li><a href="holidays.php" class="">Holidays</a></li><li><a href="applications.php" class="">Applications</a></li><li><a href="mails.php" class="active">Mails</a></li><li><a href="reports.php">Reports</a></li><li><a href="#">Settings</a><ul><li><a href="settings/my-account.php">My Account</a></li><li><a href="settings/user-account.php">User Account</a></li></ul></li></ul> 
...
<ul class="art-vmenu"><li><a href="home.php" class="">Home</a></li><li><a href="departments.php" class="">Departments</a></li><li><a href="staff.php" class="">Staff</a></li><li><a href="managers.php" class="">Managers</a></li><li><a href="leaves.php" class="">Leaves</a></li><li><a href="holidays.php" class="">Holidays</a></li><li><a href="applications.php" class="">Applications</a></li><li><a href="mails.php" class="active">Mails</a></li><li><a href="reports.php">Reports</a></li><li><a href="#">Settings</a><ul><li><a href="settings/my-account.php">My Account</a></li><li><a href="settings/user-account.php">User Account</a></li></ul></li></ul>
...
<div class="art-comment art-postcontent clearfix">
    ...
    <div class="art-comment-inner">
        <div class="art-comment-header"><?php  $sender=Staff::find_by_id($notification->sender);$receiver=Staff::find_by_id($notification->receiver);
		if($session->user_id==$notification->sender){echo "<b>Me >>>". $receiver->first_name ." ". $receiver->last_name. "</b>";}else{echo "<b>". $sender->first_name ." ". $sender->last_name ." >>> Me</b>" ;}?>&nbsp;&nbsp;&nbsp;<?php echo "(".date('l jS\,F Y h:i:s A',strtotime($notification->date_time)).") <br/><br/><b>SUBJECT: ". $notification->subject ."</b>";?></div>
